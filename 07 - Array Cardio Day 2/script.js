...
// ! NOTE: use findIndex over indexOf when iterating through objects
...
// ! NOTE: redux way of doing comment.splice(index, 1)
const newComments = [...comments.slice(0, index), ...comments.splice(index + 1)];
